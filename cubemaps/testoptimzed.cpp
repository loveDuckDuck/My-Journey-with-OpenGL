...
int main()
{
    ...
    // -------------------------
    Shader shader(FileSystem::getPath("cubemaps/reflect.vs").c_str(), 
                       FileSystem::getPath("cubemaps/reflect.fs").c_str());
    Shader skyboxShader(FileSystem::getPath("Shaders/cubemap.vs").c_str(), 
                        FileSystem::getPath("Shaders/cubemap.fs").c_str());

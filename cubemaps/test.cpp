...
int main()
{
    ...
    // -------------------------
    Shader shader(FileSystem::getPath("Shaders/material_vertex.vs").c_str(), 
                       FileSystem::getPath("Shaders/material_fragment.fs").c_str());
    Shader skyboxShader(FileSystem::getPath("cubemaps/map.vs").c_str(), 
    ...
    // load textures
    // -------------
    //unsigned int cubeTexture = TextureLoader::loadTexture(FileSystem::getPath("resources/textures/container.jpg").c_str());

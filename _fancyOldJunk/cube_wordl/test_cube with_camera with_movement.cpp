...
// ---------------------------------------------------------------------------------------------------------
void processInput(GLFWwindow *window, Camera &camera, float frameMovement)
{
    ...
    {
        camera.setCameraPosition(camera.getCameraPosition() + frameMovement * camera.getCameraFronting());
    }
    ...
    {
        camera.setCameraPosition(camera.getCameraPosition() - glm::normalize(glm::cross(camera.getCameraFronting(), camera.getCameraUping())) * frameMovement);
    }
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        frameMovement = static_cast<float>(camera.getCameraSpeed() * deltaTime);

        // input
        // -----
        processInput(window, camera, frameMovement);

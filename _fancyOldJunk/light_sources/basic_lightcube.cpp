...
int main()
{
    ...
    Shader cuberShader("material_shader.vs", "zio.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cuberShader.setVec3("light.position",  camera.Position);
        cuberShader.setVec3("light.direction", camera.Front);
        cuberShader.setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));
        cuberShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));
        ...
        glm::mat4 projection = glm::perspective(glm::radians(45.0f), 800.0f / 600.0f, 0.1f,
                                                100.0f);
        cuberShader.setUniformTransformation("view", view);
